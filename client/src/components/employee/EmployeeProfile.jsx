...
const EmployeeProfile = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${import.meta.env.REACT_APP_API_URL}/employee-api/profile/${employeeId}`)
      .then((res) => setEmployee(res.data));

    axios
      .get(`${import.meta.env.REACT_APP_API_URL}/family-api/family/${employeeId}`)
              ...
              <img
                src={
                  employee.Profile_Pic
                    ? `${import.meta.env.REACT_APP_API_URL}${employee.Profile_Pic}`
                    : employee.Photo
                    ? `${import.meta.env.REACT_APP_API_URL}${employee.Photo}`
                    : "/default-avatar.png"
                }
