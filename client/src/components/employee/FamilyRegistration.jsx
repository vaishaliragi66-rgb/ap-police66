...
const FamilyMemberRegistration = () => {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100" style={{ backgroundColor: "#f5f5f5" }}>
      <div className="p-5" style={{ width: "650px", border: "1px solid rgba(0,0,0,0.2)", borderRadius: "20px", backgroundColor: "#ffffff", color: "#000000" }}>
        <h3 className="text-center mb-4 fw-bold">Family Member Registration</h3>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-3">
            ...
            <input type="text" className="form-control" name="Weight" value={formData.Weight} onChange={handleChange} />
          </div>
          ...
          <input className="form-control mb-2" placeholder="Street" name="Address.Street" value={formData.Address.Street} onChange={handleChange} />
          <input className="form-control mb-2" placeholder="District" name="Address.District" value={formData.Address.District} onChange={handleChange} />
          <input className="form-control mb-2" placeholder="State" name="Address.State" value={formData.Address.State} onChange={handleChange} />
          <input className="form-control mb-2" placeholder="Pincode" name="Address.Pincode" value={formData.Address.Pincode} onChange={handleChange} />

          {/* Submit */}
          <button type="submit" className="btn w-100 fw-semibold mt-3" style={{ backgroundColor: "#000", color: "#fff" }}>
