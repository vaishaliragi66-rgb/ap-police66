...
const XrayEntryForm = () => {
  ...
  try {
    const res = await axios.get(
      `${import.meta.env.REACT_APP_API_URL}/xray-api/visit/${visitId}/doctor`
    );
...
const fetchXrayTypes = async () => {
  try {
    const res = await axios.get(
      `${import.meta.env.REACT_APP_API_URL}/xray-api/types`
    );
 ...
 const handleXrayChange = (index, field, value) => {
  ...
  const fetchPastRecords = async () => {
    ...
    try {
      const res = await axios.get(
        `${import.meta.env.REACT_APP_API_URL}/xray-api/records/${formData.Employee_ID}?isFamily=${formData.IsFamilyMember}&familyId=${formData.FamilyMember_ID}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `${import.meta.env.REACT_APP_API_URL}/xray-api/add`,
        {
