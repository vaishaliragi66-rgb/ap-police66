...
const XrayEntryForm = () => {
  ...
  try {
    const res = await axios.get(
      `${BACKEND_URL}:${BACKEND_PORT_NO}/xray-api/visit/${visitId}/doctor`
    );
...
const fetchXrayTypes = async () => {
  try {
    const res = await axios.get(
      `${BACKEND_URL}:${BACKEND_PORT_NO}/xray-api/types`
    );
 ...
 const handleXrayChange = (index, field, value) => {
  ...
  const fetchPastRecords = async () => {
    ...
    try {
      const res = await axios.get(
        `${BACKEND_URL}:${BACKEND_PORT_NO}/xray-api/records/${formData.Employee_ID}?isFamily=${formData.IsFamilyMember}&familyId=${formData.FamilyMember_ID}`
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `${BACKEND_URL}:${BACKEND_PORT_NO}/xray-api/add`,
        {
