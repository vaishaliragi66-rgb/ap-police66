...
const testsByCategory = {
  ...
  "VITAMINS & MINERALS": [
    ...
    { name: "TIBC", reference: "250-370", unit: "ug/dL" },
    { name: "Zinc", reference: "70-120", unit: "ug/dL" },
    { name: "Vitamin B1", reference: "2.5-7.5", unit: "ug/dL" }
  ],
  "COAGULATION STUDIES": [
    ...
    { name: "Bleeding Time", reference: "2-7", unit: "min" }
  ],
  "INFECTIOUS DISEASE": [
  ...
  "HORMONAL PROFILE": [
    ...
    { name: "Cortisol", reference: "6.2-19.4", unit: "ug/dL" },
