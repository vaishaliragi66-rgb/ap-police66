module.exports = {
  "HEMATOLOGY": [
    ...
    { name: "RBC Count", reference: "M: 4.7-6.1 | F: 4.2-5.4", unit: "million/uL" },
    { name: "WBC Count (TLC)", reference: "4,000-11,000", unit: "/uL" },
    { name: "Platelet Count", reference: "1,50,000-4,50,000", unit: "/uL" },
  ...
  "DIABETES & GLUCOSE": [
    ...
    { name: "Insulin (Fasting)", reference: "2.6-24.9", unit: "uIU/mL" },
  ...
  "KIDNEY FUNCTION TESTS (KFT)": [
    ...
    { name: "eGFR", reference: ">90 (Normal)", unit: "mL/min/1.73m2" },
  ...
  "THYROID PROFILE": [
    ...
    { name: "Total T4", reference: "4.5-12.5", unit: "ug/dL" },
  ...
  "CARDIAC MARKERS": [
    ...
    { name: "Homocysteine", reference: "5-15", unit: "umol/L" },
  ...
  "VITAMINS & MINERALS": [
    ...
    { name: "Serum Iron", reference: "M: 60-170 | F: 50-170", unit: "ug/dL" },
    { name: "Ferritin", reference: "M: 12-300 | F: 12-150", unit: "ng/mL" },
    { name: "TIBC (Total Iron Binding Capacity)", reference: "250-370", unit: "ug/dL" },
    { name: "Zinc", reference: "70-120", unit: "ug/dL" },
    { name: "Vitamin B1 (Thiamine)", reference: "2.5-7.5", unit: "ug/dL" }
  ],
  "COAGULATION STUDIES": [
    ...
    { name: "D-Dimer", reference: "<0.5", unit: "ug/mL FEU" },
  ...
  "HORMONAL PROFILE": [
    ...
    { name: "Cortisol (Morning)", reference: "6.2-19.4", unit: "ug/dL" },
    { name: "DHEA-S", reference: "M: 80-560 | F: 35-430", unit: "ug/dL" }
  ],
  "BONE HEALTH": [
