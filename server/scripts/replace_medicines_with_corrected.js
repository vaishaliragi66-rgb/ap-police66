/*
Deletes existing Medicines MasterValue entries for the institute and re-imports
all entries from imports/medicines_corrected.txt. Ensures Medicine Types exist.

Usage: node scripts/replace_medicines_with_corrected.js [instituteId]
*/
...
async function parseFile() {
  ...
  for (let raw of lines) {
    ...
    if (line.includes('\t')) {
      ...
      let strength = '';
      // extract trailing strength token if present (e.g., 250mg, 40mg/ml, 100IU)
